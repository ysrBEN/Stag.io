...
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-50 via-gray-100 to-gray-50 dark:from-[#0F1C2E] dark:via-[#1E3A5F] dark:to-[#0F1C2E] text-gray-900 dark:text-white font-sans selection:bg-teal-500 selection:text-white overflow-x-hidden transition-colors duration-300">
            ...
            {/* Hero Section */}
            <section className="relative pt-36 pb-24 md:pt-48 md:pb-32 px-6 flex flex-col items-center justify-center text-center overflow-hidden min-h-screen">
                ...
                <div className="max-w-4xl mx-auto z-10 space-y-8 animate-fade-in-up">
                    {/* Badge */}
                    <div className="inline-flex items-center px-4 py-2 rounded-full bg-teal-500/10 dark:bg-white/5 border border-teal-500/20 dark:border-white/10 backdrop-blur-md shadow-inner mb-2">
                        <span className="flex h-2 w-2 rounded-full bg-teal-500 dark:bg-teal-400 animate-pulse mr-2" />
                        <span className="text-xs font-bold tracking-wider text-teal-700 dark:text-teal-300 uppercase">100% Algérien & Officiel</span>
                    </div>
                    ...
                    <h1 className="text-5xl sm:text-7xl font-extrabold tracking-tight flex flex-col sm:flex-row items-center justify-center gap-4">
                        <div className="p-4 bg-gradient-to-br from-teal-500/20 to-blue-500/20 border border-teal-500/30 rounded-3xl shadow-2xl shadow-teal-500/10 animate-bounce">
                            <GraduationCap className="w-16 h-16 text-teal-600 dark:text-teal-400" />
                        </div>
                        <span className="bg-gradient-to-r from-gray-950 via-teal-900 to-teal-700 dark:from-white dark:via-gray-100 dark:to-teal-200 bg-clip-text text-transparent drop-shadow-sm">
                            Stag.io
                        </span>
                    </h1>

                    {/* Subtitle */}
                    <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-300 font-normal max-w-2xl mx-auto leading-relaxed">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-5 pt-4">
                        ...
                        <Link
                            to="/register"
                            className="w-full sm:w-auto flex items-center justify-center px-8 py-4 rounded-xl font-bold text-base text-gray-700 dark:text-gray-200 bg-white/80 dark:bg-white/10 hover:bg-white dark:hover:bg-white/15 border border-gray-200 dark:border-white/20 hover:border-teal-500/30 dark:hover:border-white/30 backdrop-blur-md shadow-xl hover:scale-105 transition-all group"
                        >
                            <Briefcase className="w-5 h-5 mr-2 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform" />
                            Publier une offre
                            <ArrowRight className="w-5 h-5 ml-2 opacity-80 group-hover:translate-x-1 transition-transform" />
                        </Link>
                    </div>
            ...
            <section className="relative py-24 px-6 border-t border-gray-200/50 dark:border-white/10 bg-white/60 dark:bg-[#0F1C2E]/60 backdrop-blur-3xl z-10 transition-colors duration-300">
                <div className="max-w-7xl mx-auto space-y-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {/* Students Card */}
                        <div className="bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl p-8 hover:bg-gray-50 dark:hover:bg-white/10 hover:border-teal-500/40 dark:hover:border-teal-500/40 transition-all duration-300 group shadow-xl hover:shadow-teal-500/10 flex flex-col justify-between">
                            <div>
                            ...
                            <Link to="/register" className="text-teal-600 dark:text-teal-400 font-bold inline-flex items-center hover:text-teal-500 dark:hover:text-teal-300 transition-colors group/link">
                                Rejoindre en tant qu'étudiant <ArrowRight className="w-4 h-4 ml-1 group-hover/link:translate-x-1 transition-transform" />
                            </Link>
                        </div>

                        {/* Companies Card */}
                        <div className="bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl p-8 hover:bg-gray-50 dark:hover:bg-white/10 hover:border-blue-500/40 dark:hover:border-blue-500/40 transition-all duration-300 group shadow-xl hover:shadow-blue-500/10 flex flex-col justify-between">
                            <div>
                            ...
                            <Link to="/register" className="text-blue-600 dark:text-blue-400 font-bold inline-flex items-center hover:text-blue-500 dark:hover:text-blue-300 transition-colors group/link">
                                Rejoindre en tant qu'entreprise <ArrowRight className="w-4 h-4 ml-1 group-hover/link:translate-x-1 transition-transform" />
                            </Link>
                        </div>

                        {/* Admin Card */}
                        <div className="bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl p-8 hover:bg-gray-50 dark:hover:bg-white/10 hover:border-purple-500/40 dark:hover:border-purple-500/40 transition-all duration-300 group shadow-xl hover:shadow-purple-500/10 flex flex-col justify-between">
                            <div>
                            ...
                            <Link to="/login" className="text-purple-600 dark:text-purple-400 font-bold inline-flex items-center hover:text-purple-500 dark:hover:text-purple-300 transition-colors group/link">
            ...
            {/* Footer */}
            <footer className="border-t border-gray-200 dark:border-white/10 py-8 px-6 bg-white dark:bg-[#0F1C2E] text-center text-gray-500 text-sm transition-colors duration-300">
                <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex space-x-6 text-gray-500 dark:text-gray-400">
                        <Link to="/login" className="hover:text-teal-600 dark:hover:text-white transition-colors">Connexion</Link>
                        <Link to="/register" className="hover:text-teal-600 dark:hover:text-white transition-colors">Inscription</Link>
                    </div>
                </div>
            </footer>
        </div>
